    ...
    $.ajax({
        ...
        success: function (data) {
            $.each(data, function () {
                ...
                student.append("<div class='nameDiv'><h1 class='name'>Hello My Name is:</h1><h3>"+this.name+"</h3></div>").css("height", "700px");
                student.append("<h2 class='description'>A little about me: <br></h2><p>"+this.desc+"</p>").css("height", "700px");
                student.append("<h2 class='shoutOut'>A little thank you: <br></h2><p>"+this.thanks+"</p>").css("height", "700px");
